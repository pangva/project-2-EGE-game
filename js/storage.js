...
export function load(){try{const stored=JSON.parse(localStorage.getItem('lexaRift')||'{}');return {...defaults,...stored,secretUnlocked:stored.secretUnlocked||stored.completedGames||[],secretCompleted:stored.secretCompleted||[]}}catch{return {...defaults}}}
